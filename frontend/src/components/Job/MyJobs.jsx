...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          import.meta.env.VITE_API_PATH + '/api/v1/job/getmyjobs',
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(import.meta.env.VITE_API_PATH + '/api/v1/job/update/${jobId}'
      ,updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(import.meta.env.VITE_API_PATH + '/api/v1/job/delete/${jobId}', {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
